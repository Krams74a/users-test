...
const LoggedUserLinksCard = ({website, github, twitter, instagram, facebook}) => {
            return (
...
const LoggedUserLinksCardContainer = compose()(LoggedUserLinksCard)

export default LoggedUserLinksCardContainer
